...
from toy_gym.envs.core.obstacle import Obstacle
import os
...
class PickAndPlace2D(Task):
    def __init__(self, sim: PyBullet, object_positions=[[-1.0, -1.0]], target_positions=[[2.0,4.0]],map_name="maze_world",
                goal_threshold = 0.05,random_target=False, random_object=False,
    ...
    def update_fixed_obstacle(self):
